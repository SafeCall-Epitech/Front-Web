...
// add friend : https://20.234.168.103:8080/manageFriend/user/friend/add
// rm friend : https://20.234.168.103:8080/manageFriend/user/friend/rm
  ...
  const handleAcceptFriendRequest = async (event, friendName, index) => {
    ...
    const userID = JSON.parse(localStorage.getItem('user'));
      ...
      try {
        ...
        const response = await axios.post(`https://20.234.168.103:8080/manageFriend`, form, {
          headers: {
